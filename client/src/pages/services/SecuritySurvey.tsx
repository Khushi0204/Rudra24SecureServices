    ...
    <div className="page-section">
      <div className="responsive-container">
        <div className="animate-slide-up">
          <h1 className="section-title text-center mb-4">Security Survey & Assessment</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="mb-6 text-blue-100">
                Our security survey service provides a detailed assessment of your property's security measures, identifying vulnerabilities and providing actionable recommendations to enhance your security posture.
              </p>
        ...
        <div className="mb-12 animate-slide-up">
          <h2 className="text-2xl font-bold text-blue-800 mb-8 text-center">Our Security Survey Process</h2>
        ...
        {/* Benefits Section */}
        <div className="mb-12 animate-slide-up">
          <h2 className="text-2xl font-bold text-blue-800 mb-8 text-center">Benefits of Security Surveys</h2>
        ...
        <div className="mb-12 animate-fade-in">
          <h2 className="text-2xl font-bold text-blue-800 mb-8 text-center">Types of Security Surveys</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              {
                title: "Standard Security Survey",
              ...
              >
                ...
                <Button
                  ...
                  asChild
                >
                  <a href={index === 0 ? "#survey-form" : "#contact"}>
        ...
        <div className="text-center p-8 bg-gradient-to-r from-blue-700 to-blue-800 rounded-xl text-white shadow-xl mb-12 animate-fade-in">
          ...
          <p className="max-w-2xl mx-auto mb-8 text-blue-100">
            Take the first step toward stronger security. Complete our free online assessment or contact us for a personalized security survey.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <Button
              ...
              asChild
            >
              <a href="#survey-form">START FREE SECURITY SURVEY</a>
            </Button>
            <Button
              size="lg"
              variant="outline"
              className="bg-transparent border-2 border-white text-white hover:bg-white/10 font-medium transition-all shadow-lg hover:shadow-xl animate-hover-scale text-lg px-6 py-6"
              asChild
            >
              <a href="/contact">CONTACT OUR SECURITY EXPERTS</a>
            </Button>
          </div>
        </div>

        {/* Survey Form */}
        <div id="survey-form" className="animate-slide-up">
          <h2 className="text-2xl font-bold text-blue-800 mb-4 text-center">Free Security Survey</h2>
