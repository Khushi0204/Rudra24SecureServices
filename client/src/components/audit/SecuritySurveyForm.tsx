...
export default function SecuritySurveyForm() {
  ...
  const handleSubmit = async (data: any) => {
    ...
    try {
      ...
      await sendReportEmail({
        to: finalData.email,
        subject: "Your Rudra 24 Security Survey Report",
  ...
  return (
    <section id="survey-form" className="py-16 bg-background-dark">
      <div className="container mx-auto px-4">
        <Card className="max-w-4xl mx-auto">
          <CardContent className="p-8">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold mb-3">Security Survey & Assessment</h2>
